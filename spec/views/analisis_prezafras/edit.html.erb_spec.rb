...
describe "analisis_prezafras/edit" do
  before(:each) do
  ...
  it "renders the edit analisis_prezafra form" do
    render

    # Run the generator again with the --webrat flag if you want to use webrat matchers
    assert_select "form[action=?][method=?]", analisis_prezafra_path(@analisis_prezafra), "post" do
